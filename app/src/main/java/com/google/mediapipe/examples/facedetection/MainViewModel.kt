...
class MainViewModel : ViewModel() {
    ...
    private val _detectedFace = MutableLiveData<Boolean>()
    val detectedFace: LiveData<Boolean>
        get() = _detectedFace
    ...
    fun detectFace() {
        ...
        // Misalnya, jika wajah terdeteksi, set nilai LiveData menjadi true
        _detectedFace.value = true
    }
}